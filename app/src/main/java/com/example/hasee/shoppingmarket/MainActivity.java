...
import com.example.hasee.shoppingmarket.adapter.RightDishAdapter;
import com.example.hasee.shoppingmarket.imp.ShopCartImp;
import com.example.hasee.shoppingmarket.model.Dish;
import com.example.hasee.shoppingmarket.model.DishMenu;
import com.example.hasee.shoppingmarket.model.ShopCart;
import com.example.hasee.shoppingmarket.wiget.FakeAddImageView;
import com.example.hasee.shoppingmarket.wiget.PointFTypeEvaluator;
import com.example.hasee.shoppingmarket.wiget.ShopCartDialog;
...
public class MainActivity extends AppCompatActivity implements LeftMenuAdapter.onItemSelectedListener, ShopCartImp, ShopCartDialog.ShopCartDialogImp {
    ...
    private void initData() {
        ...
        dishs4.add(new Dish("淋菜", 2.0, 10));
        dishs4.add(new Dish("川菜", 2.0, 10));
        dishs4.add(new Dish("湘菜", 2.0, 10));
...
//        fakeAddImageView = (FakeAddImageView)findViewById(R.id.right_dish_fake_add);
        ...
        rightMenu.setLayoutManager(new LinearLayoutManager(this));//recyclerview格式
